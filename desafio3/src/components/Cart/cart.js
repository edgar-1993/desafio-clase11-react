    ...
    <div>
      ...
      {!cart.length ? (
        <h2>
          ...
          <Link className="" to="/">
            {" "}
            <button className="bttn-unite bttn-md bttn-primary mb-5 seguircomprando">
              {" "}
              Ir al home
            </button>{" "}
          </Link>{" "}
        ...
        <>
          <table className="table table-striped table container Productos1 ">
            <thead className="">
              <tr>
                <th className="col-5" scope="col-5">
                  Titulo
                </th>
                <th className="col-5" scope="col-5">
                  Cantidad
                </th>
                <th className="col-2" scope="col-5">
                  🗑️
                </th>
              </tr>
            </thead>
            ...
            <div className="Productos" key={cartItem.item.id}>
              <table className="table table-striped table container Productos1">
                <tr>
                  ...
                  <th>
                    <button
                      className=" col bttn-unite bttn-md bttn-warning boton"
          ...
          <div class="alert alert-dark container mb-5" role="alert">
            ...
            <button
              className="bttn-unite bttn-md bttn-danger col-2"
              onClick={clear}
            >
              Borrar todo
            </button>
          ...
          <div className="formulario ">
            <form
              className=" input-group-text-center container mb-5 bg-secondary  formulario"
              onSubmit={finalizarCompra}
            >
              <div className="container mb-5">
                <span
                  className="input-group-text-center bttn-gradient bttn-md bttn-success"
                  id="addon-wrapping"
                >
                  Nombre
                </span>
              ...
              <div className="container mb-5  ">
                <span
                  className="input-group-text-center bttn-gradient bttn-md bttn-success mb-5 "
                  id="addon-wrapping"
                >
                  Email
                </span>
              ...
              <div className="botonesfin">
                <div>
                  <button
                    className="bttn-unite bttn-md bttn-success mb-2"
                    type="submit"
                  >
                    {" "}
                    Generar orden
              ...
              <div className="seguircomprando ">
                <button className="bttn-unite bttn-md bttn-primary mb-5">
